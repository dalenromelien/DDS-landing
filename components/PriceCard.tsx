...
const cardVariants = {
  ...
  primary:
    "bg-primary text-base-100 flex flex-col my-16 py-16 px-4 shadow-2xl text-left rounded-3xl lg:max-w-96 w-10/12",
  secondary:
    "bg-secondary text-base-100 flex flex-col my-16 py-16 px-4 shadow-2xl text-left rounded-3xl lg:max-w-96 w-10/12",
};
...
const PriceCard: React.FC<CardConfig> = (props) => {
  return (
    <div className={`${cardVariants[props.variant]} h-[40rem]`}>
      <div className="flex flex-row mx-2">
        <h1 className={`${props.titleColor} text-3xl font-bold`}>
          {props.price}
        </h1>
